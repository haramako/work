...
class Game
    ...
    showGame: ()->
        ...
        for player,i in @game.initialPlayers
            ...
            # 名前を表示
            nameDiv = $("<div>").text("P[#{player.initIdx}] pl=#{pl}　")
    ...
    send: (com,skip=true,display=true,autoplay=true)->
        ...
        if com.type == 'INIT_KYOKU'
            puts com
            puts _.pluck( @game.p, 'initIdx' )
            puts _.pluck( @game.initialPlayers, 'initIdx' )
